...
module.exports = class AfkStatusToggle {
  ...
  _createAfkButton() {
    ...
    button.style.cssText = 'background:transparent;border:none;padding:6px;margin-right:4px;border-radius:8px;cursor:pointer;color:var(--text-normal);display:flex;align-items:center;justify-content:center;';
    button.innerHTML = `
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="20" height="20" fill="currentColor" style="display:block;">
